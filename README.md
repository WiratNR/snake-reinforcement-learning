...
เวอร์ชันนี้ปรับให้ agent เล่นฉลาดขึ้นในช่วงใช้งานโมเดลที่เทรนแล้ว โดยเพิ่ม survival planner ที่หาอาหารด้วยเส้นทางปลอดภัย, ตรวจว่ากินแล้วไม่ตัดทางกลับหาง, และใช้ Hamiltonian-safe shortcut บนบอร์ด `empty` เพื่อทำคะแนนสูงโดยไม่ชน
...
| BFS planner | 25 | 208.96 | 212.0 | 328 | 2446.32 | 0% | 0% |
| Long stability check | 100 | 178.97 | 181.0 | 332 | 2043.37 | 0% | 0% |
| Smart survival planner | 25 | 494.24 | 405.0 | 1121 | 37197.60 | 0% | 0% |

โหมดเป้า 500+ บนบอร์ดเดิม **640x480** ใช้ planner ใน `agent.py` จริง ไม่เพิ่มคะแนนเทียม และไม่ปรับขนาดจอ:

```json
{"achieved": true, "score": 500, "target_score": 500, "steps": 42324, "level": "empty", "board": [640, 480], "seed": 1}
```
